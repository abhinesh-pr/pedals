...
class _AuthPageState extends State<GuestLoginPage> with SingleTickerProviderStateMixin {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text("Guest Login", style: TextStyle(fontSize: 20.sp, fontWeight: FontWeight.bold)),
              SizedBox(
                height: 450.h,
    ...
    return SingleChildScrollView(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text("Guest ID", style: TextStyle(color: Colors.black)),
            SizedBox(height: 5.h),
            TextField(
            ...
            Center(
              child: TextButton(
                ...
                onPressed: () {
                  ...
                  // Navigator.pop(context); // If you're using Navigator
                },
                child: Text(
                  "Back",
                  style: TextStyle(
